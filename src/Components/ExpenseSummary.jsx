  ...
  return (
    <div className="flex justify-center items-center">
      <div className="h-full p-2 mt-5 shadow-xl rounded-lg shadow-gray-300 flex flex-col w-[80%]  ">
        <p className="font-medium font-gray-950 mb-3">Expenses Summary</p>
        <div className="  font-light flex flex-col gap-3">
          <p className="text-sm text-gray-400">
            Today: Kshs.
            <strong className="text-red-400">{todayTotal.toFixed(2)}</strong>
          </p>
          <p className="text-sm text-gray-400">
            Weekly: Kshs.{" "}
          ...
          <div className="text-sm text-gray-400 flex items-center justify-center pt-25">
